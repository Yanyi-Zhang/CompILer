def get_args_parser(subparsers):
    ...
    subparsers.add_argument("--beta", default=0.2, type=float)
    subparsers.add_argument("--gamma", default=0.8, type=float)
    ...
    subparsers.add_argument("--dataset", default="czsl-clothing16k", type=str, help="dataset name")
    subparsers.add_argument("--nb_classes", default=35, type=int, help="dataset total classes")
    subparsers.add_argument("--shuffle", default=False, help="shuffle the data order")
    subparsers.add_argument(
        "--output_dir", default="./output/clothing16k", help="path where to save, empty for no saving"
    )
